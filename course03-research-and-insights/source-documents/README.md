...
- **Format**: Markdown (.md)
- **Source**: [MAVLINK Common Message Set](https://mavlink.io/en/messages/common.html)

### 4. Visual-Inertial Odometry Using High Flying Altitude Drone Datasets
- **Format**: Portable Document Format (.pdf)
- **Source**: [Visual-Inertial Odometry](https://www.mdpi.com/2504-446X/7/1/36)
